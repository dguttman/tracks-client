...
module Tracks
  ...
  class Base < ActiveResource::Base
    ...
    def ar_attributes
      ar_attributes = attributes.merge({"remote_#{self.element_name}_id" => self.id})
  ...
  class RemoteTodo < Base
    self.element_name = "todo"
    
    # def ar_attributes
    #   ar_attributes = attributes.merge({"remote_todo_id" => self.id})
    #   ar_attributes.delete("id")
    #   ar_attributes.delete("created_at")
    #   ar_attributes.delete("updated_at")
    #   ar_attributes
  ...
  class RemoteContext < Base
    ...
    # def ar_attributes
    #   ar_attributes = attributes.merge({"remote_context_id" => self.id})
    #   ar_attributes.delete("id")
    #   ar_attributes.delete("created_at")
    #   ar_attributes.delete("updated_at")
    #   ar_attributes
